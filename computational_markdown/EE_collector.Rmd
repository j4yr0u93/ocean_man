...
def get_creek(center, bounds):
  ...
  creek = (ee.ImageCollection('LANDSAT/LC08/C01/T1_SR')).filterDate(datetime.datetime(2016, 1, 1), datetime.datetime(2019, 12, 31)).filterBounds(creek_bounds)
            
  return(creek)
          
#setting and getting creek1, clubhead ref 
center1 = [42.740402, -70.838151, 12]
